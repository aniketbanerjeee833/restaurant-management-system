...
// router.get("/customers-spent-more-than-average",userAuth,customersSpentMoreThanAverage)
// router.get("/best-selling-item-per-kitchen",userAuth, bestSellingItemPerKitchen)
// router.get("/rank-users-by-orders",userAuth,rankUsersByOrders)

//router.get("/top-items-per-category-by-revenue",userAuth, topItemsPerCategoryByRevenue)
