...
">
  ...
  p-2  gap-6 sm:w-full sm:flex-row">
       ...
       justify-between px-4 pointer-events-none">
                    ...
                    <button
                      ...
                      className="pointer-events-auto flex
                       items-center gap-1 bg-white border border-gray-200 text-[#ff0000] font-bold px-4 py-2 rounded-full shadow-lg text-sm"
                    >
                      ☰ Categories
                    </button>
      ...
      bg-gradient-to-br from-orange-50 via-white to-red-50">
                    ...
                    {/* LEFT — Categories */}
                    {/* <aside className="w-[180px] lg:w-[200px] 
                    flex-shrink-0 bg-white shadow-md flex flex-col overflow-hidden border-r">
                    ...
                    <aside className="w-[180px] lg:w-[200px] 
  h-full flex-shrink-0 bg-white shadow-md flex flex-col overflow-y-auto border-r">
                      ...
                      <div className="flex flex-col overflow-y-auto flex-1 min-h-0 py-2 gap-1 px-2">
                        {newCategories.map((cat, index) => (
                          <button
                            type="button"
                            key={index}
