...
// import { orderApi, useConfirmTakeawayOrderBillPaidAndInvoiceGeneratedMutation, useGenerateSmsForTakeawayMutation,  useNextInvoiceNumberQuery, usePrintThermalInvoiceMutation, useTakeawayAddOrdersAndGenerateInvoicesMutation } from "../../redux/api/Staff/orderApi";
...
//         const [printThermalInvoice] = usePrintThermalInvoiceMutation();
...
//   //         <div>Customer: ${invoiceDetails?.Customer_Name ?? ""}</div>
//   //         ${invoiceDetails?.Customer_Phone ? `<div>Phone: ${invoiceDetails.Customer_Phone}</div>` : ""}

//   //         <div>Date: ${getCurrentDate()} ${getCurrentTime()}</div>
//   //         <div>Invoice: ${invoiceNumberData?.nextInvoiceNumber ?? "-"}</div>
...
//   //               <span>${it.Item_Quantity} x ₹${it.Amount}</span>
//   //             </div>
//   //           `
//   //           )
//   //           .join("")}
